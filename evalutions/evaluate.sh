...
# Fig 9
#python evaluations.py -i rtss -n 2 -s 10 -f 0.025 -h 1.83 -p 2 -u 45 -l -o # only CB
#python evaluations.py -i rtss -n 5 -s 10 -f 0.025 -h 1.83 -p 2 -u 45 -l -o # only CB

# Fig 10
#python evaluations.py -i rtss -n 2 -s 10 -f 0.025 -h 1.83 -p 2 -u 45 -o # only CB
#python evaluations.py -i rtss -n 5 -s 10 -f 0.025 -h 1.83 -p 2 -u 45 -o # only CB

# Fig 11
#python evaluations.py -i rtss -n 15 -s 10 -f 0.025 -h 1.83 -p 2 -u 45 -o # only CB
#python evaluations.py -i rtss -n 25 -s 10 -f 0.025 -h 1.83 -p 2 -u 45 -o # only CB
